#!/usr/bin/env python3
"""
Run Azure ML experiment for stock price prediction
"""
...
def run_experiment():
    ...
    try:
        ...
        # Wait for completion (optional - you can also check in Azure ML Studio)
        print("\n⏳ Waiting for experiment to complete...")
        print("You can also monitor progress in Azure ML Studio:")
