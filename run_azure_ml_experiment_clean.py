#!/usr/bin/env python3
"""
Run Azure ML experiment for stock price prediction (clean version)
"""
...
def create_environment():
    ...
    conda_dep.add_pip_package("yfinance")
...
def run_experiment():
    ...
    try:
        ...
        script_config = ScriptRunConfig(
            source_directory="./azure_ml_training",  # Use the clean directory
            script="azure_ml_train_stock_model.py",
            arguments=[
                "--symbol", "AAPL",
                "--period", "2y",
                "--n_estimators", "200",
        ...
        print("This may take 10-15 minutes for the first run (environment setup + training)")
